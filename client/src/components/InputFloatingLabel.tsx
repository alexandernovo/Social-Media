...
const InputFloatingLabel: React.FC<InputFloatingLabelProps> = ({ label, id, name, type, placeholder, value, onChange, classes, onInput, onClick, required }) => {
    const className = `${classes} block rounded-2xl px-2.5 pb-3.5 pt-4 indent-1 w-full text-sm text-black bg-white border border-gray-400 appearance-none text-black focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer`;
    return (
